        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            if (ValidatePasswordChange())
            {
                try
                {
                    ...
                    if (result > 0)
                    {
                        ClientScript.RegisterStartupScript(this.GetType(), "requestSuccess", "alert('Profile Update successfully.');window.location.href='ManagerHome.aspx';", true);
                    ...
                    {
                        ClientScript.RegisterStartupScript(this.GetType(), "requestError", "alert('Error Profile Update.');window.location.href='ManagerHome.aspx';", true);
